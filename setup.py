...
Indxgeneral = (
    "CREATE INDEX indiceForeignKeys ON general (action, user, category, subcategory);"
)
...
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (1, 'restaurante', 'alimentacao');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (1, 'supermercado', 'alimentacao');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (2, 'internet', 'casa');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (2, 'luz', 'casa');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (2, 'condominio', 'casa');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (2, 'telefone', 'casa');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (2, 'aluguel', 'casa');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (2, 'manutencao', 'casa');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (3, 'onibus', 'transporte');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (3, 'gasolina', 'transporte');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (3, 'taxi', 'transporte');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (4, 'gym', 'esporte');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (5, 'exames', 'saude');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (5, 'farmacia', 'saude');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (6, 'monotributo', 'burocracia');"
)
conn.execute(
    "insert into subcategory(catid, subcategory, category) values (0, 'outros', '');"
)
